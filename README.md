...
Bert Molenkamp has released a [VHDL description of the ARC processor](http://iiusatech.com/murdocca/CAO/VHDL.html). Although the ARC processor is a three address machine, the overall code structuring was proven to be quite helpful during our project. Bert made his code open source and freely available. We will do the same, such that both systems can work as a base for new research and development.
